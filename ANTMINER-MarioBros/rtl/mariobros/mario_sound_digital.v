...
//   output   signed [15:0]O_SND_DAC,
   output   signed [15:0]O_SND_OUT,
    output [11:0]SND_ADDR
);

assign SND_ADDR = S_ROM_A;
...
assign O_DATA = S_ROM_A == 12'h001 ? 8'h01 : S_PROG_D; // 8039 hack
//--------------------------------------------------------------------------
// M58715 Data Bus
wire    [7:0]M58715_DO = S_7J_OC == 1'b0 ? I_SND_DATA : O_DATA; // S_PROG_D;
