...
/*   Gowin_SP2 ram_64_9(
        .dout(O_DA), //output [8:0] dout
        .clk(I_CLKA), //input clk
        .oce(1'b1), //input oce
        .ce(I_CEA), //input ce
        .reset(1'b0), //input reset
        .wre(I_WEA), //input wre
        .ad(I_ADDRA), //input [5:0] ad
        .din(I_DA) //input [8:0] din
    );
*/
