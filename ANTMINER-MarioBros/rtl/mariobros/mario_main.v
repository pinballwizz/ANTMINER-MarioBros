...
wire  [7:0]W_MROM_DO;
wire  [7:0]cpu_rom1_do;
wire  [7:0]cpu_rom2_do;

//MAIN_ROM mrom(I_CLK_48M, W_MCPU_A, W_MROM_CS_n, W_MCPU_RDn, W_MROM_DO, 
//              I_CLK_48M, I_DLADDR, I_DLDATA, I_DLWR);
//---------------------------------------------------------------------------

assign W_MROM_DO = 	(W_MROM_CS_n[0] == 1'b0 & W_MCPU_RDn == 1'b0) ? cpu_rom1_do :
					(W_MROM_CS_n[1] == 1'b0 & W_MCPU_RDn == 1'b0) ? cpu_rom1_do :
					(W_MROM_CS_n[2] == 1'b0 & W_MCPU_RDn == 1'b0) ? cpu_rom1_do :
					(W_MROM_CS_n[3] == 1'b0 & W_MCPU_RDn == 1'b0) ? cpu_rom2_do :
					8'h00;
